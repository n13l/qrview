#define PACKAGE_VERSION_STRING 0.0.1
#define PACKAGE_VERSION 000001
#define CPU_ARCH x86
#define CONFIG_WINDOWS 1
#define CPU_ARCH x86
#define CPU_CHAR_BITS 8
#define CPU_BITS_SIZE 32
#define CPU_STRUCT_ALIGN 4
#define CPU_ALLOW_UNALIGNED 1
#define CPU_LITTLE_ENDIAN 1
#define CPU_ARCH x86
#define CPU_PAGE_SIZE 4096
#define CONFIG_HAVE_CC gcc
...
#define CONFIG_HAVE_GTK__WIN32_3_0_STATIC 1
#define CONFIG_HAVE_GTK__WIN32_3_0_STATIC_VERSION 3.4.2
...
#define CONFIG_HAVE_LIBQRENCODE_VERSION 1.1.1
#define CONFIG_HAVE_LIBQRENCODE_CFLAGS -mms-bitfields -I/usr/i686-w64-mingw32/build/include/qrencode 
#define CONFIG_HAVE_LIBQRENCODE_LDFLAGS -L/usr/i686-w64-mingw32/build/lib /usr/i686-w64-mingw32/build/lib/qrencode/libqrencode.a 
